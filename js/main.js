...
function simpleTemplating(data) {
  var html = '<div class="col-xl-4 col-sm-6 col-6" id="pro">';
  $.each(data, function (index, item) {
    ...
    html += "<ul>";
    html += '<li class="sale-badge">' + product[index].sale + "</li>";
    html += "</ul>";
    html += "</div>";
    html +=
    ...
    html += "</div>";
    html +=
      '<div class="product-info"><div class="product-ratting"><ul><li><a href="#"><i class="fas fa-star"></i></a></li><li><a href="#"><i class="fas fa-star"></i></a></li><li><a href="#"><i class="fas fa-star"></i></a></li><li><a href="#"><i class="fas fa-star-half-alt"></i></a></li><li><a href="#"><i class="far fa-star"></i></a></li></ul></div><h2 class="product-title"><a href="product-details.html">' +
      product[index].name +
      '</a></h2><div class="product-price"><span>$' +
      product[index].price +
      "</span></div></div>";
    html += "</div>";
  });
